...
public class BuscadorService {
	...
	public void buscaComParser(String indicacao, String contraIndicacao, String reacaoAdversa) {
		...
		try {
			...
			if (!indicacao.contains("null") && contraIndicacao.contains("null") && reacaoAdversa.contains("null")) {
			...
			} else if (indicacao.contains("null") && !contraIndicacao.contains("null") && reacaoAdversa.contains("null")){
				...
				logger.info("Iniciando a procura por dados recebidos: " + indicacao + ", " +contraIndicacao+ ", " +reacaoAdversa);
